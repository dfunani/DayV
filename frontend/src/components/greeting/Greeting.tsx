	...
	return (
		<div className="Main Greet">
			...
			<div className="To-Container">
				...
				<input type="text" id="ToInput" onInputCapture={(e) => setGreet((prev) => ({...prev, to: e.target.value.toUpperCase() + ', '}))}/>
			</div>
			<div className="Select-Greeting">
				<label htmlFor="SelectGreeting">Select Greeting:</label>
				<select name="Select Greeting" id="SelectGreeting" onChange={(e) => setGreet((prev) => ({...prev, select: e.target.value}))}>
			...
			<div className="From-Container">
				...
				<input type="text" id="FromInput" onInputCapture={(e) => setGreet((prev) => ({...prev, from: 'From: ' + e.target.value.toUpperCase(e)}))}/>
			</div>
		</div>
	)
}